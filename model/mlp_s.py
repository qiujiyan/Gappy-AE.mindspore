...
class MLP_s(nn.Cell):
    ...
    def __init__(self,args ):
        ...
        self.f1=nn.Dense(self.input_size , 600)
        self.f2=nn.Dense(600, 128)
        self.f3=nn.Dense(128, self.mod_number)
        self.f4=nn.Dense(self.mod_number,128)
        self.f5=nn.Dense(128, 600)
        self.f6=nn.Dense(600, self.input_size )
        self.layers = [
            self.f1,
            self.f2,
            self.f3,
