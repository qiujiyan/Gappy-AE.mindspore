...
class MLP_x(nn.Cell):
    ...
    def __init__(self,args ):
        ...
        self.f1=nn.Dense(self.input_size , 8000)
        self.f2=nn.Dense(8000, 2800)
        self.f3=nn.Dense(2800, self.mod_number)
        self.f4=nn.Dense(self.mod_number,2800)
        self.f5=nn.Dense(2800, 8000)
        self.f6=nn.Dense(8000, self.input_size )
        self.layers = [
            self.f1,
            self.f2,
            self.f3,
